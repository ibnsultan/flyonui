        ...
        <div class="relative flex items-center justify-center px-4 sm:px-6 lg:px-8 w-[480px] max-w-full">
            ...
            <div class="bg-base-100 shadow-base-300/20 z-1 w-full space-y-6 rounded-xl p-6 shadow-md sm:max-w-md lg:p-8">
              ...
              <span class="text-primary">
                ...
                <div class="space-y-4">
                    <form class="mb-4 space-y-4" action="{{ route('register') }}" method="POST">
                        @csrf
                        <div>
                            <label class="label-text" for="userName">Username*</label>
                            <input type="text" name="name" placeholder="Enter your username" class="input @error('name') input-error @enderror" id="userName" value="{{ old('name') }}" required />
                            @error('name')
                        ...
                        <div>
                            <label class="label-text" for="userConfirmPassword">Confirm Password*</label>
                            <div class="input">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="checkbox" class="checkbox checkbox-primary checkbox-sm" id="policyagreement" name="terms" />
                            <label class="label-text text-base-content/80 p-0 text-base" for="policyagreement"> I agree
                                to <a href="#" class="link link-animated link-primary font-normal">privacy policy &
                                    terms?</a> </label>
                        </div>
